...
public class TC25 extends BrowserUtility1{
	...
	public static void main(String[] args) throws Exception{
		...
		driver.findElement(By.xpath("//input[@id='name_lastcon2']")).sendKeys("CK");
		driver.findElement(By.xpath("//input[@id='con4']")).sendKeys("Selenium");
